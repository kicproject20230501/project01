...
<body
   ...
   background-size: cover;">
	...
	<!-- 체크값 보내고 받아주는 부분 -->
	<form method="post" name="RadioPost" id="RadioPost"
		action="${pageContext.request.contextPath }/survey/surveyInsertPro">
		<input type="hidden" name="page" value=""> <input
			type="hidden" name="ck1gender" value="${ck1gender}"> <input
			type="hidden" name="ck2favorite" value="${ck2favorite}"> <input
			type="hidden" name="ck3fruit" value="${ck3fruit}"> <input
			type="hidden" name="ck3flower" value="${ck3flower}"> <input
			type="hidden" name="ck3wood" value="${ck3wood}"> <input
			type="hidden" name="anslistImage" value="${anslistImage}">
		<div class="recommend p-5 h1"
			...
			<a href="#" class="m-auto" onclick="next('product')"
				style="width: 350px; display: inline-block;"> <!-- 설문 결과에따른 사진 가능하면 추가사진 -->
				<img class="rounded-2"
